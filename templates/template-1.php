										...
										<table id="footer" width="490" border="0" cellpadding="0" bgcolor="#ffffff" cellspacing="0" style="line-height:1.5;font-size:12px;font-family: Arial, sans-serif;margin-right:30px;margin-left:30px;">
											<tr style="font-size:11px;color:#999999;">
												<td style="border-top: solid 1px #d9d9d9;" colspan="2">
													<div style="padding-top:15px; padding-bottom:1px;"><img height="13" width="13" style="vertical-align: middle;" src="' . admin_url('images/date-button.gif') . '" alt="' . esc_attr__('Date', 'edd-promo') . '"  /> ' . esc_attr__('Email sent on:', 'edd-promo') .'</div>
													<div><img height="12" width="12" style="vertical-align: middle;" src="' . admin_url('images/comment-grey-bubble.png') . '" alt="' . esc_attr__('Contact', 'edd-promo') . '"  /> ' . __('For any requests, please contact', 'edd-promo') . ' <a href="mailto:' .get_option( 'admin_email' ) .'">support</a>
													<br><br>
